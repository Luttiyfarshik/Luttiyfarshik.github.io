  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>+7(926)984-45-15</p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Middle Education Diplom</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2010 - 2021 - <span class="w3-tag w3-teal w3-round"></span></h6>
          <p>МБОУ Гимназия № 23 г. Химки, корпус № 1</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>MSTU "STANKIN"</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2021 - now</h6>
          <p>Automatization (15.03.04)</p>
          <hr>
        </div>
        <div class="w3-container">
...
<footer class="w3-container w3-teal w3-center w3-margin-top">
  ...
  <p>Powered by <a href="https://stankin.ru/" target="_blank">MSTU "STANKIN"</a></p>
</footer>
